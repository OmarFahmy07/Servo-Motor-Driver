...
void (*GLOB_VidOVFPtrCallBack)(void) = NULL;
void (*GLOB_VidOCAPtrCallBack)(void) = NULL;
void (*GLOB_VidOCBPtrCallBack)(void) = NULL;
void (*GLOB_VidCaptureEventPtrCallBack)(void) = NULL;
...
{
	if (LOC_U8Edge == FALLING_EDGE)
	{
		CLR_BIT(TCCR1B_REGISTER, ICES1);
		return NO_ERROR;
	}
	else if (LOC_U8Edge == RISING_EDGE)
	{
...
u8 Timer1_U8OVFSetCallBack( void (*ptrToFun)(void) )
{
	if (ptrToFun != NULL)
	{
		GLOB_VidOVFPtrCallBack = ptrToFun;
		return NO_ERROR;
	}
	else
	{
...
u8 Timer1_U8OCASetCallBack( void (*ptrToFun)(void) )
{
	if (ptrToFun != NULL)
	{
		GLOB_VidOCAPtrCallBack = ptrToFun;
		return NO_ERROR;
	}
	else
	{
...
u8 Timer1_U8OCBSetCallBack( void (*ptrToFun)(void) )
{
	if (ptrToFun != NULL)
	{
		GLOB_VidOCBPtrCallBack = ptrToFun;
		return NO_ERROR;
	}
	else
	{
...
u8 Timer1_U8CaptureEventSetCallBack( void (*ptrToFun)(void) )
{
	if (ptrToFun != NULL)
	{
		GLOB_VidCaptureEventPtrCallBack = ptrToFun;
		return NO_ERROR;
	}
	else
	{
...
{
	if (GLOB_VidOVFPtrCallBack != NULL)
	{
		(*GLOB_VidOVFPtrCallBack)();
	}
}

void __vector_8(void)
{
	if (GLOB_VidOCBPtrCallBack != NULL)
	{
		(*GLOB_VidOCBPtrCallBack)();
	}
}

void __vector_7(void)
{
	if (GLOB_VidOCAPtrCallBack != NULL)
	{
		(*GLOB_VidOCAPtrCallBack)();
	}
}

void __vector_6(void)
{
	if (GLOB_VidCaptureEventPtrCallBack != NULL)
	{
		(*GLOB_VidCaptureEventPtrCallBack)();
	}
}
